 ...
 * @author Camis
 */
public class ConsultarUmHotel extends javax.swing.JFrame {

    /**
     * Creates new form ConsultarUmHotel
     */
    HotelControle hc = new HotelControle();

    public ConsultarUmHotel() {
        initComponents();
        popularCombo();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagem/icone.png"))); // NOI18N
        ...
        jLabel3.setText("Consultar Um Hotel");
        ...
        jLabel17.setText("Codigo Cidade");
    ...
    private void jComboBox1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox1ActionPerformed
        if (jComboBox1.getSelectedItem() != null) {
            ...
            int codigoSelecionado = Integer.parseInt(item.split(" - ")[0]);

            ArrayList<Hotel> hoteis = hc.consultarHoteis();

            for (Hotel h : hoteis) {
                if (h.getCodHotel() == codigoSelecionado) {
                    Cnpj.setText(h.getCNPJ());
                    Local.setText(h.getLocal());
                    Endereco.setText(h.getEndereco());
                    CheckIn.setText(h.getCheckIn().toString());
                    CheckOut.setText(h.getCheckOut().toString());
                    Cidade.setText(String.valueOf(h.getCodCidade()));
                    break;
                }
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsultarUmHotel.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ConsultarUmHotel().setVisible(true);
            }
        });
    }
